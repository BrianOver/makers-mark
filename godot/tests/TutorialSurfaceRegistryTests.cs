...
/// <c>MainUi.ModalContent</c>'s five-arm switch, which MISSED real MainUi-mounted surfaces
/// (the Scrying Mirror, the PiP dock, the Companion Docket). This suite
...
public class TutorialSurfaceRegistryTests
{
    ...
    private static readonly string[] SurfacesWithNoWayInYet = ["Heroes", "Pip"];
