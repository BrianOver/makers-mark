...
public partial class MainUi : Control
{
    ...
    private void SyncCampModal()
    {
        ...
        else if (state.Phase == DayPhase.Camp)
        {
            ...
            // parks in the first place (see TutorialFlow.NotifyCampCardShown's own doc). A no-op
            // once Step has moved past Vigil (mirrors NotifyMirrorOpened's own idiom for the day-1
            // capstone).
