    ...
    private static ImmutableSortedDictionary<string, Vocab> BuildTable() => new Dictionary<string, Vocab>
    {
        ...
        [ProfessionRegistry.BlacksmithId] = new Vocab(
            ...
            new[]
            {
                ...
                // U-T1 (register #147): the furnace used to share the shelf's "materials" Focus,
                // so stoking it opened the ore vendor — the furnace's own business (coal, flux,
                // the forge-tier upgrade) is the Foundry, ForgePanel's own third section.
                new InteriorLayout2D.StationSpec("furnace", "Furnace", "town2d-station-furnace", new Vector2I(6, 5), "Forge", Focus: "foundry",
                ...
                new InteriorLayout2D.StationSpec("quench", "Quench Trough", "town2d-station-quench", new Vector2I(15, 7), Action: null,
                    HoverLine: "Quench trough — the plunge that finishes what the anvil starts",
                    FlavorLine: "The water sits ready for the plunge. This is the craft's second act — start at the anvil and the quench takes its turn."),
