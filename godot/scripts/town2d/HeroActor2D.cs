...
public partial class HeroActor2D : Node2D
{
    ...
    public override void _Process(double delta)
    {
        ...
        // U-T3-8: while Wandering, normalize cadence/lean against the ERRAND pace (60), not the
        // 260px/s expedition-march pace — the two are deliberately different constants (see
