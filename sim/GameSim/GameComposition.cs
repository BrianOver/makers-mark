...
public static class GameComposition
{
    public static GameKernel BuildKernel() => new(
        ...
        ImmutableList.Create<IActionHandler>(
            ...
            new ConcludeApprenticeshipHandlers(), // §11.13 amendment (U4a): ConcludeApprenticeshipAction, all phases, mutates nothing (draws no RNG — see class doc)
            new PledgeDuesHandlers())); // P2-LONG-18: PledgeDuesAction, all phases like CraftAction — the guild's noticeboard never closes (draws no RNG)
