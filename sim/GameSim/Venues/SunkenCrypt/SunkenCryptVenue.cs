...
public static class SunkenCryptVenue
{
    ...
    private static VenueDefinition Build()
    {
        ...
        // LadderRank 0: a Mine-peer EARLY venue by design — same gate ladder, grade 1-5 ores.
        // The router splits the rank-0 band between the Crypt and the Mine by queue length.
        return new VenueDefinition(Id, "The Sunken Crypt", floors.ToImmutable(), LadderRank: 0);
    }
}
